...
WorkspacePath          := "/home/pi/apt-encoder"
ProjectPath            := "/home/pi/apt-encoder"
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/pi/apt-encoder/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/aptcode.c$(ObjectSuffix): aptcode.c $(IntermediateDirectory)/aptcode.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/pi/apt-encoder/aptcode.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/aptcode.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/audioset.c$(ObjectSuffix): audioset.c $(IntermediateDirectory)/audioset.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/pi/apt-encoder/audioset.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/audioset.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/image.c$(ObjectSuffix): image.c $(IntermediateDirectory)/image.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/pi/apt-encoder/image.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/image.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/wavwrite.c$(ObjectSuffix): wavwrite.c $(IntermediateDirectory)/wavwrite.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/pi/apt-encoder/wavwrite.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/wavwrite.c$(ObjectSuffix) $(IncludePath)
